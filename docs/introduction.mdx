...
Tree-shaking ensures a React consumer never pulls in Vue/Svelte/Solid/Angular code, and vice versa. Need a framework we don't support? [Build your own adapter](/frameworks/custom) in 20–40 lines.
